...
In addition to gender, this report looks at the housing status of refugees. Figure 2 depicts the number of refugees that were reported as being actively homeless between the years 2018 and 2022. @tbl-docvisittable

```{r}
#| echo: false
#| message: false
#| label: tbl-docvisittable
#| tbl-cap: "Number of Actively Homeless Refugees Identified in Toronto"
